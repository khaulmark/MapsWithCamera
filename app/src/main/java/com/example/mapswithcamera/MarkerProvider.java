...
public class MarkerProvider extends ContentProvider {
    ...
    private static String LOGTAG = "MarkerProvider:";
    // Database Name for SQLITE DB
    private static final String DBNAME = "MarkerDB";
    // Authority is the package name
    private static final String AUTHORITY = "com.example.mapswithcamera.markerprovider";
    //TABLE_NAME is defined as ToDoList
    private static final String TABLE_NAME = "MapsWithCamera";
    //Create a CONTENT_URI for use by other classes
    public static final Uri CONTENT_URI =
            Uri.parse("content://" + AUTHORITY + "/"+TABLE_NAME);

    //Column names for the ToDoList Table
    public static final String MARKER_TABLE_COL_ID = "_ID";
    public static final String MARKER_TABLE_COL_TITLE = "TITLE";
    public static final String MARKER_TABLE_COL_ABSOLUTEPATH = "ABSOLUTEPATH";
    public static final String MARKER_TABLE_COL_LATITUDE = "LATITUDE";
    public static final String MARKER_TABLE_COL_LONGITUDE = "LONGITUDE";
    
    //Table create string based on column names
    private static final String SQL_CREATE_MAIN = "CREATE TABLE " +
            TABLE_NAME+ " " +                       // Table's name
            "(" +                           // The columns in the table
            MARKER_TABLE_COL_ID + " INTEGER PRIMARY KEY, " +
            MARKER_TABLE_COL_TITLE + " TEXT," +
            MARKER_TABLE_COL_ABSOLUTEPATH + " TEXT," +
            MARKER_TABLE_COL_LATITUDE + " DOUBLE," +
            MARKER_TABLE_COL_LONGITUDE + " DOUBLE)";
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        switch (sUriMatcher.match(uri)){
            ...
            case 2:
                ...
                selection = MARKER_TABLE_COL_ID + "=" + id +
    ...
    protected static final class MainDatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int int1, int int2){
            ...
            db.execSQL("DROP TABLE IF EXISTS MapsWithCamera");
            onCreate(db);
        }
    }
